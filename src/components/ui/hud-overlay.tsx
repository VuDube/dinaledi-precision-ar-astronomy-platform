  ...
  return (
    <TooltipProvider>
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 z-20 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-[0.03] overflow-hidden flex flex-wrap gap-12 p-12">
        ...
        <div className="flex justify-between items-start relative z-10">
          <div className="flex flex-col gap-2">
            ...
            <div className="glass px-4 py-3 rounded-xl flex items-center gap-4 animate-fade-in pointer-events-auto shadow-glow/10 border-white/5">
            ...
            <div className="flex gap-2 pointer-events-auto">
              <div className="glass px-3 py-1.5 rounded-lg flex items-center gap-2 border-white/5">
        ...
        <AnimatePresence>
          {activeTarget && (
            ...
            >
              <div className="glass-dark border-nebula/40 px-6 py-5 rounded-3xl flex flex-col items-center gap-4 shadow-2xl min-w-[280px] backdrop-blur-xl">
                ...
                {activeTarget?.lore && (
                  <div className="text-[10px] text-starlight/70 leading-relaxed max-w-[220px] text-center border-t border-white/5 pt-2 italic">
                    {activeTarget.lore}
                  </div>
                )}
                <Button 
