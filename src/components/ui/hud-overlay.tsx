    ...
    <>
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 z-20 overflow-hidden">
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex flex-col gap-2 pointer-events-auto items-end">
            ...
            <Button 
              variant="ghost" 
              size="icon" 
              className="glass h-10 w-10 text-starlight active:scale-95 transition-all"
            ...
            >
              <div className="glass-dark border-nebula/30 px-6 py-4 rounded-2xl flex flex-col items-center gap-3 shadow-[0_0_40px_rgba(234,179,8,0.15)] min-w-[240px]">
                <div className="flex flex-col items-center gap-1">
                  <div className="text-nebula text-[10px] font-bold uppercase tracking-[0.2em] drop-shadow-glow">Target Acquired</div>
                ...
                <Button
                  ...
                  onClick={() => {
                    // Selection is handled via Dialog in ObservationForm reacting to selectedStar
                  }}
                >
        ...
        <div className="flex-1 flex items-center justify-center relative">
          <Crosshair className={cn("w-16 h-16 transition-colors duration-300", selectedStar ? "text-nebula scale-110" : "text-starlight/20")} strokeWidth={0.5} />
        </div>
        {/* Navigation Footer */}
